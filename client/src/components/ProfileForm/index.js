      ...
      {Auth.loggedIn() ? (
        <>
          {clicked ? (
            <>
              <form
                className="flex flex-col items-center text-start bg-secondary"
              ...
              >
                ...
                <input
                  className="input-md bg-secondary-focus bg-primary rounded input-bordered input-accent w-full max-w-xs"
                  type="text"
                  name="skills"
                ...
                <input
                  className="input-md bg-secondary-focus rounded input-bordered input-accent w-full max-w-xs"
                  type="text"
                  name="interests"
                ...
                <input
                  className="input-md border-accent bg-secondary-focus rounded input-bordered input-accent w-full max-w-xs"
                  type="text"
                  name="websites"
                ...
                <input
                  className="input-md border-accent bg-secondary-focus rounded input-bordered input-accent w-80 md:w-3/6 lg:w-1/2 xl:w-1/2"
                  type="text"
                  name="location"
            ...
            <>
              <div className="pt-1 bg-secondary flex flex-col items-center">
                <div className="card text-center card-bordered bg-secondary-focus border-accent m-5 p-5 shadow-2xl shadow-black w-80 md:w-3/6 lg:w-1/2 xl:w-1/3 h-fit">
                  <span className="text-4xl text-stone-200 font-extrabold">
                    Bio
                  </span>
